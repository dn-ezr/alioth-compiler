...
constexpr typeid_t CompositeType =             (TypeIdBitL << 0x04) | DeterminedTypeMask;
constexpr typeid_t EntityType =                (TypeIdBitL << 0x05) | DeterminedTypeMask;
constexpr typeid_t ConstraintedPointerType =   (TypeIdBitL << 0x06) | PointerTypeMask;
constexpr typeid_t UnconstraintedPointerType = (TypeIdBitL << 0x07) | PointerTypeMask;
constexpr typeid_t NullPointerType =           (TypeIdBitL << 0x08) | PointerTypeMask;
constexpr typeid_t VoidType =                  (TypeIdBitL << 0x09) | BasicTypeMask;
constexpr typeid_t BooleanType =               (TypeIdBitL << 0x0a) | BasicTypeMask;
constexpr typeid_t Uint8Type =                 (TypeIdBitL << 0x0b) | UnsignedIntegerTypeMask;
constexpr typeid_t Uint16Type =                (TypeIdBitL << 0x0c) | UnsignedIntegerTypeMask;
constexpr typeid_t Uint32Type =                (TypeIdBitL << 0x0d) | UnsignedIntegerTypeMask;
constexpr typeid_t Uint64Type =                (TypeIdBitL << 0x0e) | UnsignedIntegerTypeMask;
constexpr typeid_t Int8Type =                  (TypeIdBitL << 0x0f) | SignedIntegerTypeMask;
constexpr typeid_t Int16Type =                 (TypeIdBitL << 0x10) | SignedIntegerTypeMask;
constexpr typeid_t Int32Type =                 (TypeIdBitL << 0x11) | SignedIntegerTypeMask;
constexpr typeid_t Int64Type =                 (TypeIdBitL << 0x12) | SignedIntegerTypeMask;
constexpr typeid_t Float32Type =               (TypeIdBitL << 0x13) | FloatPointTypeMask;
constexpr typeid_t Float64Type =               (TypeIdBitL << 0x14) | FloatPointTypeMask;
